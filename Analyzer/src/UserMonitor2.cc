...
bool EventMonitor2::ProcessingNormal( Decoder& gDec )
{
  ...
  int chx1=1, chx2=5, chs1=6, chs2=7;//For VthAC
  int chx1t=2, chx2t=4, chs1t=6, chs2t=8;

  // int chx1=1, chx2=2, chs1=5, chs2=6;
  // int chx1t=2, chx2t=4, chs1t=6, chs2t=8;//From run038
  // //int chx1t=1, chx2t=3, chs1t=5, chs2t=7; 
