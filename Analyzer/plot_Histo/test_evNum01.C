...
void test_evNum01()
{
  TFile *fin = new TFile("test_run040.root");
  ...
  TH2F *hist[6];
  hist[0] = new TH2F("h1", "AMP vs DT", 100, 0, 600, 100, -3, 3);
  hist[1] = new TH2F("h2", "AMP vs DT", 100, 0, 600, 100, -3, 3);

  hist[2] = new TH2F("h3", "TDC1 vs lTDC1", 100, 180, 190, 100, 175, 190);
  hist[3] = new TH2F("h4", "TDC2 vs lTDC2", 100, 180, 190, 100, 175, 190);
