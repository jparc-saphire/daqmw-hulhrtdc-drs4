...
{ 
  ...
  TH2F *h1001=new TH2F("h1001","", 600,1,600, 600,1,60);
  TH2F *h1002=new TH2F("h1002","", 600,1,600, 600,1,60);
  TH2F *h1011=new TH2F("h1011","", 600,1,600, 600,1,60);
  TH2F *h1012=new TH2F("h1012","", 600,1,600, 600,1,60);

  TChain chain1("tree");
  chain1.Add( "test_run008.root" );
  chain1.Project("h1001","width[0]:amp[0]","hrdt[0]>0&&hrdt_2nd[0]>0");
  chain1.Project("h1011","width[0]:amp[0]","hrdt[0]>0&&hrdt_2nd[0]>0");
  chain1.Project("h1002","width[1]:amp[1]","hrdt[1]>0&&hrdt_2nd[1]>0");
  chain1.Project("h1012","width[1]:amp[1]","hrdt[1]>0&&hrdt_2nd[1]>0");
  ...
  c1->cd(1)->SetLogy(0);
  c1->cd(1)->SetLogz();
  TH1F* Hc1=c1->cd(1)->DrawFrame( 0.0, 0.0, 400.0, 20.0 );
  ...
  c1->cd(2)->SetLogy(0);
  c1->cd(2)->SetLogz();
  TH1F* Hc2=c1->cd(2)->DrawFrame( 0.0, 0.0, 400.0, 20.0 );
  ...
  c1->cd(3)->SetLogy(0);
  c1->cd(3)->SetLogz();
  TH1F* Hc3=c1->cd(3)->DrawFrame( 0.0, 0.0, 200.0, 15.0 );
  ...
  c1->cd(4)->SetLogy(0);
  c1->cd(4)->SetLogz();
  TH1F* Hc4=c1->cd(4)->DrawFrame( 0.0, 0.0, 200.0, 15.0 );
