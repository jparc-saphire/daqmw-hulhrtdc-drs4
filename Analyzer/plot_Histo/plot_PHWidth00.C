...
{ 
  ...
  TH2F *h1001=new TH2F("h1001","", 300,1,900, 60,1,60);
  TH2F *h1002=new TH2F("h1002","", 300,1,900, 60,1,60);
  TH2F *h1011=new TH2F("h1011","", 300,1,900, 60,1,60);
  TH2F *h1012=new TH2F("h1012","", 300,1,900, 60,1,60);

  TChain chain1("tree");
  chain1.Add( "test_run024.root" );
  ...
  c1->cd(1)->SetLogy(0);
  c1->cd(1)->SetLogz();
  TH1F* Hc1=c1->cd(1)->DrawFrame( 0.0, 0.0, 900.0, 60.0 );
  ...
  c1->cd(2)->SetLogy(0);
  c1->cd(2)->SetLogz();
  TH1F* Hc2=c1->cd(2)->DrawFrame( 0.0, 0.0, 900.0, 60.0 );
  ...
  c1->cd(3)->SetLogy(0);
  c1->cd(3)->SetLogz();
  TH1F* Hc3=c1->cd(3)->DrawFrame( 0.0, 0.0, 900.0, 40.0 );
  ...
  c1->cd(4)->SetLogy(0);
  c1->cd(4)->SetLogz();
  TH1F* Hc4=c1->cd(4)->DrawFrame( 0.0, 0.0, 900.0, 40.0 );
