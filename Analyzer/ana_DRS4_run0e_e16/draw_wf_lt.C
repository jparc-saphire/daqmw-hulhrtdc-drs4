...
void draw_wf_lt(int run_number, int sub_run = 0){
    ...
    //        TFile *file0 = new TFile(Form("./data/run%06d_1.root", run_number), "read");
	...
	*/
	//	const Double_t lt_min_ac4 = 1600.;
	const Double_t lt_min_ac4 = 1880.;
	const Double_t lt_max_ac4 = 2010.;
	const Double_t lt_min_ac1 = 1980.;
	const Double_t lt_max_ac1 = 2010.;
	...
	if (good_ch1_tdc) {
	  ...
	  g_wf1 -> GetYaxis() -> SetLimits(-300, 300);
	  g_wf1 -> Draw("apl");
	}
	...
	if (good_ch2_tdc) {	
	  ...
	  g_wf2 -> GetYaxis() -> SetLimits(-300, 300);
	  g_wf2 -> Draw("apl");
	}
	...
	if (good_ch3_tdc) { 	
	  ...
	  g_wf3 -> GetYaxis() -> SetLimits(-300, 300);
	  g_wf3 -> Draw("apl");
	}
