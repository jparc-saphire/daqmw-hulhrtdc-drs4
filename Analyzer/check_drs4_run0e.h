#ifndef check_drs4_run0e_h
#define check_drs4_run0e_h
...
class check_drs4_run0e{
  ...
  void     fileopen0(Int_t run, Int_t subrun=0);
    ...
    check_drs4_run0e(Int_t run, Int_t subrun=0, TString basedir = "./data");
...
#ifdef check_drs4_run0e_cc

void check_drs4_run0e::fileopen0(Int_t run, Int_t subrun)
{
...
void check_drs4_run0e::Init0(TTree *tree){
  /*def
...
void check_drs4_run0e::count(Int_t Nevent, Int_t eventid){
