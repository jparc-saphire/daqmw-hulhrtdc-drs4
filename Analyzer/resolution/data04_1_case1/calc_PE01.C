void calc_PE01()
{
  ...
  double ph1[N]  =  {19.90, 29.67, 37.94, 48.27, 57.77, 67.70};  
  double ph1E[N] =  { 1.00,  0.03,  0.03,  0.10,  0.12,  0.17};  

  double ph2[N]  =  {17.70, 26.91, 36.61, 47.70, 55.93, 65.68};  
  double ph2E[N] =  { 1.00,  0.06,  0.07,  0.05,  0.09,  0.11};  
