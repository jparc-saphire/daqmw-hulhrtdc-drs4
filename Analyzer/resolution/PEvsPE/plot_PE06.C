...
void plot_PE06()
{
  ...
  c1->cd(1)->SetGrid();
  c1->cd(1)->SetLogy(0);
  TH1F* Hc1=c1->cd(1)->DrawFrame( 0, 0.0, 30.0, 900.0 );
  ...
  c1->cd(2)->SetGrid();
  c1->cd(2)->SetLogy(0);
  TH1F* Hc2=c1->cd(2)->DrawFrame( 0, 0.0, 30.0, 900.0 );
  ...
  c1->cd(3)->SetGrid();
  c1->cd(3)->SetLogy(0);
  TH1F* Hc3=c1->cd(3)->DrawFrame( 0, 0.0, 12.0, 1000.0 );
  ...
  c1->cd(4)->SetGrid();
  c1->cd(4)->SetLogy(0);
  TH1F* Hc4=c1->cd(4)->DrawFrame( 0, 0.0, 12.0, 1000.0 );
  ...
  c1->cd(5)->SetLogy(0);
  c1->cd(5)->SetLogz();
  TH1F* Hc5=c1->cd(5)->DrawFrame( 0, 0.0, 30.0, 12.0 );
  ...
  c1->cd(6)->SetLogy(0);
  c1->cd(6)->SetLogz();
  TH1F* Hc6=c1->cd(6)->DrawFrame( 0, 0.0, 30.0, 12.0 );
