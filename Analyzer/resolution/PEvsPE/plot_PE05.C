...
void plot_PE05()
{
  ...
  TH1F *hist2[2];
  hist2[0] = new TH1F("h1_2", "Width1", 400, 0, 20);
  hist2[1] = new TH1F("h2_2", "Width2", 400, 0, 20);

  TH2F *hist3[2];
  hist3[0] = new TH2F("h1_3", "Width vs PE 1", 300, 0, 30, 100, 0, 20);
  hist3[1] = new TH2F("h2_4", "Width vs PE 2", 300, 0, 30, 100, 0, 20);

  TFile *fin = new TFile("../../test_run072.root");
  ...
  for(int i = 0; i<n; ++i){
    tree->GetEntry(i);
    if( ltdc1[0]>0.&&ttdc2[0]>0.&&amp1[0]>0.&&amp2[0]>0.){

      double pe1 = 0.110*amp1[0]+0.84;
      double pe2 = 0.105*amp2[0]+1.18;

      hist1[0]->Fill(pe1);
      hist1[1]->Fill(pe2);

      double w1 = ltdc1[0]-ttdc1[0];
      double w2 = ltdc2[0]-ttdc2[0];
      hist2[0]->Fill(w1);
      hist2[1]->Fill(w2);
      hist3[0]->Fill(pe1,w1);
      hist3[1]->Fill(pe2,w2);
  ...
  c1->cd(1)->SetGrid();
  c1->cd(1)->SetLogy(0);
  TH1F* Hc1=c1->cd(1)->DrawFrame( 0, 0.0, 30.0, 300.0 );
  ...
  c1->cd(2)->SetGrid();
  c1->cd(2)->SetLogy(0);
  TH1F* Hc2=c1->cd(2)->DrawFrame( 0, 0.0, 30.0, 300.0 );
  ...
  c1->cd(3)->SetGrid();
  c1->cd(3)->SetLogy(0);
  TH1F* Hc3=c1->cd(3)->DrawFrame( 0, 0.0, 15.0, 300.0 );
  ...
  c1->cd(4)->SetGrid();
  c1->cd(4)->SetLogy(0);
  TH1F* Hc4=c1->cd(4)->DrawFrame( 0, 0.0, 15.0, 300.0 );
