...
void plot_PE03_2()
{
  ...
  TH1F *hist2[2];
  hist2[0] = new TH1F("h1_2", "Width1", 300, 0, 30);
  hist2[1] = new TH1F("h2_2", "Width2", 300, 0, 30);

  TH2F *hist3[2];
  hist3[0] = new TH2F("h1_3", "Width vs PE 1", 300, 0, 30, 150, 0, 30);
  hist3[1] = new TH2F("h2_4", "Width vs PE 2", 300, 0, 30, 150, 0, 30);
  ...
  c1->cd(3)->SetGrid();
  c1->cd(3)->SetLogy(0);
  TH1F* Hc3=c1->cd(3)->DrawFrame( 0, 0.0, 25.0, 250.0 );
  ...
  c1->cd(4)->SetGrid();
  c1->cd(4)->SetLogy(0);
  TH1F* Hc4=c1->cd(4)->DrawFrame( 0, 0.0, 25.0, 200.0 );
  ...
  c1->cd(5)->SetLogy(0);
  c1->cd(5)->SetLogz();
  TH1F* Hc5=c1->cd(5)->DrawFrame( 0, 0.0, 30.0, 25.0 );
  ...
  c1->cd(6)->SetLogy(0);
  c1->cd(6)->SetLogz();
  TH1F* Hc6=c1->cd(6)->DrawFrame( 0, 0.0, 30.0, 25.0 );
