void calc_PE03()
{
  ...
  double ph1[N]  =  {20.78, 26.06, 30.31, 37.47, 43.75, 49.57};  
  double ph1E[N] =  { 0.08,  0.18,  0.14,  0.03,  0.12,  0.13};  

  double ph2[N]  =  {18.66, 24.07, 29.72, 35.20, 41.08, 48.00};  
  double ph2E[N] =  { 0.06,  0.04,  0.08,  0.10,  0.09,  0.20};  
  ...
  c1->cd(1)->SetGrid();
  TH1F* Hc1=c1->cd(1)->DrawFrame( 10., 0.0, 60.0, 10.0 );
  ...
  c1->cd(2)->SetGrid();
  TH1F* Hc2=c1->cd(2)->DrawFrame( 10., 0.0, 60.0, 10.0 );
