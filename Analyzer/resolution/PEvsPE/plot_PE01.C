...
void plot_PE01()
{
  ...
  TFile *fin1 = new TFile("../../test_run029.root");
  ...
  for(int i = 0; i<n1; ++i){
    ...
    if( ltdc1_1[0]>0.&&ttdc1_1[0]>0.&&amp1_1[0]>0.){
      ...
      double pe1 = 0.0520*amp1_1[0]-1.72;
      hist1[0]->Fill(pe1);
  ...
  TFile *fin2 = new TFile("../../test_run031.root");
  ...
  for(int i = 0; i<n2; ++i){
    ...
    if( ltdc2_1[0]>0.&&ttdc2_1[0]>0.&&amp2_1[0]>0.){
      ...
      double pe2 = 0.0892*amp2_1[0]+0.95;
      hist1[1]->Fill(pe2);
  ...
  c1->cd(2)->SetGrid();
  c1->cd(2)->SetLogy(0);
  TH1F* Hc2=c1->cd(2)->DrawFrame( 0, 0.0, 30.0, 700.0 );
  ...
  c1->cd(3)->SetGrid();
  c1->cd(3)->SetLogy(0);
  TH1F* Hc3=c1->cd(3)->DrawFrame( 0, 0.0, 15.0, 1200.0 );
  ...
  c1->cd(4)->SetGrid();
  c1->cd(4)->SetLogy(0);
  TH1F* Hc4=c1->cd(4)->DrawFrame( 0, 0.0, 15.0, 800.0 );
