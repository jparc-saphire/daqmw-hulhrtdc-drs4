void calc_PE01()
{
  ...
  double ph1[N]  =  {109.9, 129.7, 148.0, 168.1, 186.9};  
  double ph1E[N] =  { 0.19,  0.23,  0.28,  0.34,  0.34};  

  double ph2[N]  =  {90.74, 109.7, 128.6, 148.0, 166.7};  
  double ph2E[N] =  { 0.20,  0.24,  0.27,  0.27,  0.39};  
