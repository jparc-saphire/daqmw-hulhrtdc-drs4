...
void resolution2()
{
  ...
  hist[7] = new TH1F("h8", "TOF8",  20, -1, 1);
  ...
  for(int i = 0; i<n; ++i){
    ...
    if(181.0<ltdc1[0]&&ltdc1[0]<190.0&&181.0<ltdc2[0]&&ltdc2[0]<190.0&&
       177.0<ttdc1[0]&&ttdc1[0]<186.0&&177.0<ttdc2[0]&&ttdc2[0]<181.0){
      ...
      if( rw1>2.5 && rw2>2.5 ){
	hist[0]->Fill(TOF-0.05);	
	hist21[0]->Fill(rw1);
	hist22[0]->Fill(rw2);
      }
      if( rw1>3.0 && rw2>3.0 ){
	hist[1]->Fill(TOF-0.04);
	hist21[1]->Fill(rw1);
	hist22[1]->Fill(rw2);
      }
      if( rw1>3.5 && rw2>3.5 ){
	hist[2]->Fill(TOF-0.04);
	hist21[2]->Fill(rw1);
	hist22[2]->Fill(rw2);
      }
      if( rw1>4.0 && rw2>4.0 ){
	hist[3]->Fill(TOF-0.04);
	hist21[3]->Fill(rw1);
	hist22[3]->Fill(rw2);
      }
      if( rw1>4.5 && rw2>4.5 ){
	...
	hist22[4]->Fill(rw2);
      ...
      if( rw1>5.0 && rw2>5.0 ){
	hist[5]->Fill(TOF-0.03);
	hist21[5]->Fill(rw1);
	hist22[5]->Fill(rw2);
      }
      if( rw1>5.5 && rw2>5.5 ){
	hist[6]->Fill(TOF-0.02);
	hist21[6]->Fill(rw1);
	hist22[6]->Fill(rw2);
      }
      if( rw1>5.8 && rw2>5.8 ){
	hist[7]->Fill(TOF-0.06);
	hist21[7]->Fill(rw1);
	hist22[7]->Fill(rw2);
      }
    }
  ...
  double cut[Nh] = { 2.5, 3.0, 3.5, 4.0, 4.5, 5.0, 5.5, 5.8};
  ...
  c2->cd(1)->SetGrid();
  TH1F* Hc1=c2->cd(1)->DrawFrame( 1,  0.0, 7.0, 185.0 );
  ...
  c3->cd(1)->SetGrid();
  TH1F* Hc2=c3->cd(1)->DrawFrame( 4,  0.0, 6.5, 185.0 );
