...
void timewalkcorr1()
{
  ...
  TH2F *hist[2];
  hist[0] = new TH2F("h1", "TOF1vsWIDTH1", 1000, 0, 5, 100, -5, 5);
  hist[1] = new TH2F("h2", "TOF1vsWIDTH2", 1000, 0, 5, 100, -5, 5);

  int n = tree->GetEntries();
  for(int i = 0; i<n; ++i){
    tree->GetEntry(i);
    if(174.0<ltdc1[0]&&ltdc1[0]<186.0&&174.0<ltdc2[0]&&ltdc2[0]<186.0&&
       171.0<ttdc1[0]&&ttdc1[0]<182.0&&171.0<ttdc2[0]&&ttdc2[0]<182.0){

      double w1 = ltdc1[0]-ttdc1[0]-2.3;
      double w2 = ltdc2[0]-ttdc2[0]-2.0;
      
      hist[0]->Fill(w1,(ltdc1[0]-ltdc2[0])+0.32);
      hist[0]->GetXaxis()->SetTitle("WIDTH1");
      hist[0]->GetYaxis()->SetTitle("TOF");
      
      hist[1]->Fill(w2,(ltdc1[0]-ltdc2[0])+0.32);
