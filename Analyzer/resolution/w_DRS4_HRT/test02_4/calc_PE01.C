void calc_PE01()
{
  ...
  double ph1[N]  =  {57.34, 69.30, 81.48, 93.60, 105.4, 117.6};  
  double ph1E[N] =  { 0.07,  0.12,  0.13,  0.18,  0.18,  0.26};  

  double ph2[N]  =  {53.53, 65.48, 77.05, 88.74, 101.1, 112.3};  
  double ph2E[N] =  { 0.07,  0.13,  0.14,  0.15,  0.14,  0.21};  

  double pe1[N]  =  {7., 8., 9., 10., 11., 12.};  
  double pe1E[N] =  {0., 0., 0., 0., 0., 0.};  

  double pe2[N]  =  {7., 8., 9., 10., 11., 12.};  
  ...
  c1->cd(1)->SetGrid();
  TH1F* Hc1=c1->cd(1)->DrawFrame( 20., 0.0, 130.0, 13.0 );
  ...
  c1->cd(2)->SetGrid();
  TH1F* Hc2=c1->cd(2)->DrawFrame( 20., 0.0, 130.0, 13.0 );
