...
void plot_PE01()
{
  ...
  c1->cd(1)->SetGrid();
  c1->cd(1)->SetLogy(0);
  TH1F* Hc1=c1->cd(1)->DrawFrame( 0, 0.0, 30.0, 1300.0 );
  ...
  c1->cd(3)->SetGrid();
  c1->cd(3)->SetLogy();
  TH1F* Hc3=c1->cd(3)->DrawFrame( 0, 0.1, 30.0, 2500.0 );
  ...
  c1->cd(2)->SetGrid();
  c1->cd(2)->SetLogy(0);
  TH1F* Hc2=c1->cd(2)->DrawFrame( 0, 0.0, 30.0, 1500.0 );
  ...
  c1->cd(4)->SetGrid();
  c1->cd(4)->SetLogy();
  TH1F* Hc4=c1->cd(4)->DrawFrame( 0, 0.1, 30.0, 2500.0 );
