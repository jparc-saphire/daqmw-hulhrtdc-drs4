void calc_PE01()
{
  ...
  double ph1[N]  =  {112.6, 131.7, 151.4, 170.5, 190.1};  
  double ph1E[N] =  { 0.1, 0.1, 0.15, 0.15, 0.2};  

  double ph2[N]  =  {92.65, 111.8, 131.6, 150.3, 170.6};  
  double ph2E[N] =  { 0.1, 0.1, 0.15, 0.15, 0.2};  
