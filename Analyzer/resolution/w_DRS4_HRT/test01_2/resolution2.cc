...
void resolution2()
{
  ...
  hist[2] = new TH1F("h3", "TOF3", 150, -1, 1);
  hist[3] = new TH1F("h4", "TOF4", 100, -1, 1);
  hist[4] = new TH1F("h5", "TOF5",  90, -1, 1);
  hist[5] = new TH1F("h6", "TOF6",  80, -1, 1);
  hist[6] = new TH1F("h7", "TOF7",  70, -1, 1);
  ...
  for(int i = 0; i<n; ++i){
    ...
    if( tdc1[0]>0&&tdc2[0]>0&&amp1[0]>0&&amp2[0]>0){
      ...
      double pe1 = 0.0516*amp1[0]-1.81;
      double pe2 = 0.0516*amp2[0]-0.73;
      ...
      double TOFa = ((tdc1[0]-tdc2[0])-0.66)-T1;
      double TOF1 = TOFa-T2;
      ...
      if( rA1>2.5 && rA2>2.5 ){
	hist[0]->Fill(TOF-0.06);
	hist21[0]->Fill(rA1);
	hist22[0]->Fill(rA2);
      }
      if( rA1>5.0 && rA2>5.0){
	hist[1]->Fill(TOF-0.06);
	hist21[1]->Fill(rA1);
	hist22[1]->Fill(rA2);
      }
      if( rA1>7.5 && rA2>7.5){
	hist[2]->Fill(TOF-0.06);
	hist21[2]->Fill(rA1);
	hist22[2]->Fill(rA2);
      }
      if( rA1>10.0 && rA2>10.0){
	hist[3]->Fill(TOF-0.06);
	hist21[3]->Fill(rA1);
	hist22[3]->Fill(rA2);
      }
      if( rA1>12.5 && rA2>12.5){
	hist[4]->Fill(TOF-0.06);
	hist21[4]->Fill(rA1);
	hist22[4]->Fill(rA2);
      }
      if( rA1>15.0 && rA2>15.0){
	hist[5]->Fill(TOF-0.07);
	hist21[5]->Fill(rA1);
	hist22[5]->Fill(rA2);
      }
      if( rA1>17.5 && rA2>17.5){
	hist[6]->Fill(TOF-0.07);
	hist21[6]->Fill(rA1);
	hist22[6]->Fill(rA2);
      }
      if( rA1>20.0 && rA2>20.0){
	hist[7]->Fill(TOF-0.07);
	hist21[7]->Fill(rA1);
	hist22[7]->Fill(rA2);
      }
    }
  ...
  for(int i=0; i<Nh; ++i){
    ...
    hist[i]->Fit("fit1", "", "", -0.22+0.015*i, 0.22-0.015*i);
