...
void resolution2()
{
  TFile *fin = new TFile("../../test_run024.root");
  ...
  hist[7] = new TH1F("h8", "TOF8",  80, -1, 1);
  ...
  for(int i = 0; i<n; ++i){
    ...
    if( tdc1[0]>0&&tdc2[0]>0&&amp1[0]>0&&amp2[0]>0){
      ...
      double pe1 = 0.0530*amp1[0]-1.88;
      double pe2 = 0.0522*amp2[0]-1.72;
  ...
  for(int i=0; i<Nh; ++i){
    ...
    hist[i]->Fit("fit1", "", "", -0.22+0.016*i, 0.22-0.016*i);
