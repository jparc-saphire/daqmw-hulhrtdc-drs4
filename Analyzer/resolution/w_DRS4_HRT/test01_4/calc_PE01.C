void calc_PE01()
{
  ...
  double ph1[N]  =  {149.0, 167.2, 186.9, 205.7, 224.2};  
  double ph1E[N] =  { 0.26,  0.38,  0.36,  0.41,  0.56};  

  double ph2[N]  =  {147.9, 166.9, 186.4, 205.5, 224.2};  
  double ph2E[N] =  { 0.20,  0.26,  0.33,  0.33,  0.42};  

  double pe1[N]  =  {6., 7., 8., 9., 10.};  
  double pe1E[N] =  {0., 0., 0., 0., 0.};  

  double pe2[N]  =  {6., 7., 8., 9., 10.};  
  ...
  c1->cd(1)->SetGrid();
  TH1F* Hc1=c1->cd(1)->DrawFrame( 120., 0.0, 240.0, 11.0 );
  ...
  c1->cd(2)->SetGrid();
  TH1F* Hc2=c1->cd(2)->DrawFrame( 120., 0.0, 240.0, 11.0 );
