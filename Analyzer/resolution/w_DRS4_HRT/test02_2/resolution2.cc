...
void resolution2()
{
  ...
  for(int i = 0; i<n; ++i){
    ...
    if( tdc1[0]>0&&tdc2[0]>0&&amp1[0]>0&&amp2[0]>0){
      ...
      double pe1 = 0.0901*amp1[0]+1.92;
      double pe2 = 0.0883*amp2[0]+2.24;
      ...
      double TOFa = ((tdc1[0]-tdc2[0])-0.60)-T1;
      double TOF1 = TOFa-T2;
	...
	hist[3]->Fill(TOF-0.05);
	hist21[3]->Fill(rA1);
	hist22[3]->Fill(rA2);
      }
      if( rA1>12.5 && rA2>12.5){
	hist[4]->Fill(TOF-0.05);
	hist21[4]->Fill(rA1);
	hist22[4]->Fill(rA2);
      }
