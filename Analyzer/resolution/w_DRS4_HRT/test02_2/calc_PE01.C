void calc_PE01()
{
  ...
  double ph1[N]  =  {23.25, 33.55, 44.84, 56.15, 68.05, 79.89};  
  double ph1E[N] =  { 0.03,  0.07,  0.07,  0.07,  0.12,  0.15};  

  double ph2[N]  =  {20.11, 31.00, 42.39, 53.78, 65.27, 76.85};  
  double ph2E[N] =  { 0.06,  0.07,  0.06,  0.10,  0.09,  0.13};  
