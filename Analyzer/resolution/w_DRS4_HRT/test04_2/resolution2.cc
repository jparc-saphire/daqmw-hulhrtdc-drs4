...
void resolution2()
{
  TFile *fin = new TFile("../../test_run013.root");
  ...
  for(int i = 0; i<n; ++i){
    ...
    if( tdc1[0]>0&&tdc2[0]>0&&amp1[0]>0&&amp2[0]>0){
      ...
      double pe1 = 0.0754*amp1[0]+1.70;
      double pe2 = 0.0752*amp2[0]+1.91;
      ...
      if( rA1>2.5 && rA2>2.5 ){
	hist[0]->Fill(TOF+0.056);
	hist21[0]->Fill(rA1);
	hist22[0]->Fill(rA2);
      }
      if( rA1>5.0 && rA2>5.0){
	hist[1]->Fill(TOF+0.056);
	hist21[1]->Fill(rA1);
	hist22[1]->Fill(rA2);
      }
      if( rA1>7.5 && rA2>7.5){
	hist[2]->Fill(TOF+0.054);
	hist21[2]->Fill(rA1);
	hist22[2]->Fill(rA2);
      }
      if( rA1>10.0 && rA2>10.0){
	hist[3]->Fill(TOF+0.055);
	hist21[3]->Fill(rA1);
	hist22[3]->Fill(rA2);
      }
      if( rA1>12.5 && rA2>12.5){
	hist[4]->Fill(TOF+0.059);
	hist21[4]->Fill(rA1);
	hist22[4]->Fill(rA2);
      }
      if( rA1>15.0 && rA2>15.0){
	hist[5]->Fill(TOF+0.061);
	hist21[5]->Fill(rA1);
	hist22[5]->Fill(rA2);
      }
      if( rA1>17.5 && rA2>17.5){
	hist[6]->Fill(TOF+0.072);
	hist21[6]->Fill(rA1);
	hist22[6]->Fill(rA2);
      }
      if( rA1>20.0 && rA2>20.0){
	hist[7]->Fill(TOF+0.077);
	hist21[7]->Fill(rA1);
	hist22[7]->Fill(rA2);
      }
    }
