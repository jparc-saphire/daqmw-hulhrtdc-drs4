void calc_PE01()
{
  ...
  double ph1[N]  =  {30.75, 43.55, 56.72, 70.32, 83.89, 97.50};  
  double ph1E[N] =  { 0.04,  0.05,  0.06,  0.08,  0.12,  0.13};  

  double ph2[N]  =  {28.01, 40.85, 54.23, 67.48, 81.00, 94.96};  
  double ph2E[N] =  { 0.05,  0.05,  0.06,  0.08,  0.11,  0.12};  
  ...
  c1->cd(1)->SetGrid();
  TH1F* Hc1=c1->cd(1)->DrawFrame( 20., 0.0, 105.0, 10.0 );
  ...
  c1->cd(2)->SetGrid();
  TH1F* Hc2=c1->cd(2)->DrawFrame( 20., 0.0, 105.0, 10.0 );
