void calc_PE01()
{
  ...
  double ph1[N]  =  {34.28, 45.56, 57.19, 68.54, 81.06, 92.92};  
  double ph1E[N] =  { 0.10,  0.10,  0.10,  0.12,  0.12,  0.20};  

  double ph2[N]  =  {31.43, 42.40, 54.00, 65.29, 77.14, 89.08};  
  double ph2E[N] =  { 0.04,  0.10,  0.13,  0.11,  0.14,  0.18};  

  double pe1[N]  =  {5., 6., 7., 8., 9., 10.};  
  double pe1E[N] =  {0., 0., 0., 0., 0., 0.};  

  double pe2[N]  =  {5., 6., 7., 8., 9., 10.};  
  ...
  c1->cd(1)->SetGrid();
  TH1F* Hc1=c1->cd(1)->DrawFrame( 20., 0.0, 100.0, 11.0 );
  ...
  c1->cd(2)->SetGrid();
  TH1F* Hc2=c1->cd(2)->DrawFrame( 20., 0.0, 100.0, 11.0 );
