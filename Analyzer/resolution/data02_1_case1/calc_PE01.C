void calc_PE01()
{
  ...
  double ph1[N]  =  {23.16, 34.13, 44.64, 56.45, 67.94, 79.80};  
  double ph1E[N] =  { 0.06,  0.34,  0.12,  0.15,  0.15,  0.17};  

  double ph2[N]  =  {19.80, 30.32, 41.61, 52.71, 64.38, 76.02};  
  double ph2E[N] =  { 0.06,  0.08,  0.09,  0.15,  0.14,  0.16};  
