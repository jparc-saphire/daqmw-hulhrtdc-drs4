...
void resolution2()
{
 ...
 for(int i = 0; i<n; ++i){
    ...
    if(172.0<ltdc1[0]&&ltdc1[0]<182.0&&172.0<ltdc2[0]&&ltdc2[0]<182.0&& 
      ...
      double w1 = ltdc3[0]-ttdc3[0]-5.7;
      double w2 = ltdc4[0]-ttdc4[0]-5.3;
      ...
      double rw1 = w1+5.7;
      double rw2 = w2+5.3+0.7;
      
      if( pe1>0.0 && pe2>0.0 ){
	if( rw1>2.0 && rw2>2.0 ){
	  hist[0]->Fill(TOF+0.07);	
	  hist21[0]->Fill(rw1);
	  hist22[0]->Fill(rw2);
	}
	if( rw1>4.0 && rw2>4.0 ){
	...
	if( rw1>7.5 && rw2>7.5 ){
	  hist[4]->Fill(TOF-0.01);
	  hist21[4]->Fill(rw1);
	  hist22[4]->Fill(rw2);
	}
	if( rw1>8.0 && rw2>8.0 ){
	  hist[5]->Fill(TOF+0.00);
	  hist21[5]->Fill(rw1);
	  hist22[5]->Fill(rw2);
	}
	if( rw1>8.5 && rw2>8.5 ){
	  hist[6]->Fill(TOF+0.01);
	  hist21[6]->Fill(rw1);
	  hist22[6]->Fill(rw2);
	}
	if( rw1>9.0 && rw2>9.0 ){
	  hist[7]->Fill(TOF+0.00);
	  hist21[7]->Fill(rw1);
	  hist22[7]->Fill(rw2);
	}
      }
  ...
  c2->cd(1)->SetGrid();
  TH1F* Hc1=c2->cd(1)->DrawFrame( 1,  0.0, 11.5, 170.0 );
