...
void resolution3()
{
  ...
  hist[7] = new TH1F("h8", "TOF8",  40, -1, 1);
 ...
 for(int i = 0; i<n; ++i){
	...
	if( pe1>15.0 && pe2>15.0 ){
	  hist[5]->Fill(TOF-0.01);
	  hist21[5]->Fill(rw1);
	  hist22[5]->Fill(rw2);
	  hist31[5]->Fill(pe1);
	  hist32[5]->Fill(pe2);
	}
	if( pe1>17.5 && pe2>17.5 ){
	...
	if( pe1>19.5 && pe2>19.5 ){
	  hist[7]->Fill(TOF+0.02);
	  hist21[7]->Fill(rw1);
	  hist22[7]->Fill(rw2);
	  hist31[7]->Fill(pe1);
	  hist32[7]->Fill(pe2);
  ...
  c2->cd(1)->SetGrid();
  TH1F* Hc1=c2->cd(1)->DrawFrame( 5,  0.0, 25.0, 170.0 );
