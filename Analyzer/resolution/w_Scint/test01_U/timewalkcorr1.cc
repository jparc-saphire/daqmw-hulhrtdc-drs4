...
void timewalkcorr1()
{
  ...
  for(int i = 0; i<n; ++i){
	...
	hist[0]->Fill(amp1[0]-70.0,tdc1[0]-(tdc3[0]+tdc4[0])/2.0-6.24);
	hist[0]->GetXaxis()->SetTitle("AMP1");
	hist[0]->GetYaxis()->SetTitle("TOF1");
	
	hist[2]->Fill(amp3[0]-50.0,tdc1[0]-(tdc3[0]+tdc4[0])/2.0-6.24);
	hist[2]->GetXaxis()->SetTitle("AMP3");
	hist[2]->GetYaxis()->SetTitle("TOF1");
	
	hist[3]->Fill(amp4[0]-60.0,tdc1[0]-(tdc3[0]+tdc4[0])/2.0-6.24);
