...
void timewalkcorr2()
{
  ...
  TH2F *hist[4];
  hist[0] = new TH2F("h1", "TOF1vsAMP1",  600, 0,  600, 100, -3, 3);
  hist[1] = new TH2F("h2", "TOF1vsAMP2",  600, 0,  600, 100, -3, 3);
  hist[2] = new TH2F("h3", "TOF1vsAMP3", 1000, 0, 1000, 100, -3, 3);
  hist[3] = new TH2F("h4", "TOF1vsAMP4", 1000, 0, 1000, 100, -3, 3);
