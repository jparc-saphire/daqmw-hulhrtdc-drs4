...
void timewalkcorr1_1()
{
  ...
  TH2F *hist[4];
  hist[0] = new TH2F("h1", "TOF1vsAMP1",  600, 0,  600, 100, -5, 5);
  hist[1] = new TH2F("h2", "TOF1vsAMP2",  600, 0,  600, 100, -5, 5);
  hist[2] = new TH2F("h3", "TOF1vsAMP3", 1000, 0, 1000, 100, -5, 5);
  hist[3] = new TH2F("h4", "TOF1vsAMP4", 1000, 0, 1000, 100, -5, 5);
  ...
  for(int i = 0; i<n; ++i){
	...
	amp1[0]>0.&&amp2[0]>0.&&amp3[0]>0.&&amp4[0]>0.){
      ...
      if( Amp1>0 && Amp2>0 && Amp3>0 && Amp4>0){
	hist[0]->Fill(amp1[0],(tdc1[0]+tdc2[0])/2.0-(tdc3[0]+tdc4[0])/2.0-5.94);
	hist[0]->GetXaxis()->SetTitle("AMP1");
	hist[0]->GetYaxis()->SetTitle("TOF1");
	
	hist[1]->Fill(amp2[0],(tdc1[0]+tdc2[0])/2.0-(tdc3[0]+tdc4[0])/2.0-5.94);
	hist[1]->GetXaxis()->SetTitle("AMP2");
	hist[1]->GetYaxis()->SetTitle("TOF1");
	
	hist[2]->Fill(amp3[0],(tdc1[0]+tdc2[0])/2.0-(tdc3[0]+tdc4[0])/2.0-5.94);
	hist[2]->GetXaxis()->SetTitle("AMP3");
	hist[2]->GetYaxis()->SetTitle("TOF1");
	
	hist[3]->Fill(amp4[0],(tdc1[0]+tdc2[0])/2.0-(tdc3[0]+tdc4[0])/2.0-5.94);
