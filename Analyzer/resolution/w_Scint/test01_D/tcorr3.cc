...
void tcorr3()
{
  ...
  for(int i = 0; i<n; ++i){
	...
	hist[1]->Fill((amp2[0]-60.0),TOF3);
	hist[1]->GetXaxis()->SetTitle("AMP2");
	hist[1]->GetYaxis()->SetTitle("TOF3");
	hist[2]->Fill((amp3[0]-50.0),TOF3);
	hist[2]->GetXaxis()->SetTitle("AMP3");
	hist[2]->GetYaxis()->SetTitle("TOF3");
	hist[3]->Fill((amp4[0]-60.0),TOF3);
	hist[3]->GetXaxis()->SetTitle("AMP4");
	hist[3]->GetYaxis()->SetTitle("TOF3");
      }
    }
  }
