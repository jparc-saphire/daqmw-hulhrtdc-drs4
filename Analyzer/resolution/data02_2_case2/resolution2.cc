...
void resolution2()
{
  TFile *fin = new TFile("../../test_run035.root");
  ...
  for(int i = 0; i<n; ++i){
    ...
    if( ltdc1[0]>0&&ltdc2[0]>0&&amp1[0]>0&&amp2[0]>0){
      ...
      double pe1 = 0.0851*amp1[0]+1.09;
      double pe2 = 0.0880*amp2[0]+1.34;
      ...
      double TOFa = ((ltdc1[0]-ltdc2[0])+0.70)-T1;
      double TOF1 = TOFa-T2;
