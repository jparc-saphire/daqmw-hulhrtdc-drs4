...
void resolution2()
{
 ...
 for(int i = 0; i<n; ++i){
	...
	hist22[0]->Fill(rw2);
      ...
      if( rw1>3.5 && rw2>3.5 ){
	hist[1]->Fill(TOF+0.07);
	hist21[1]->Fill(rw1);
	hist22[1]->Fill(rw2);
      }
      if( rw1>4.5 && rw2>4.5 ){
	hist[2]->Fill(TOF+0.07);
	hist21[2]->Fill(rw1);
	hist22[2]->Fill(rw2);
	}
      if( rw1>5.5 && rw2>5.5 ){
	hist[3]->Fill(TOF+0.09);
	hist21[3]->Fill(rw1);
	hist22[3]->Fill(rw2);
      }
      if( rw1>6.5 && rw2>6.5 ){
	hist[4]->Fill(TOF+0.10);
	hist21[4]->Fill(rw1);
	hist22[4]->Fill(rw2);
      }
      if( rw1>7.5 && rw2>7.5 ){
	hist[5]->Fill(TOF+0.11);
	hist21[5]->Fill(rw1);
	hist22[5]->Fill(rw2);
	}
      if( rw1>8.5 && rw2>8.5 ){
	hist[6]->Fill(TOF+0.11);
	hist21[6]->Fill(rw1);
	hist22[6]->Fill(rw2);
      }
      if( rw1>9.5 && rw2>9.5 ){
	hist[7]->Fill(TOF+0.10);
	hist21[7]->Fill(rw1);
	hist22[7]->Fill(rw2);
      }
    }
  ...
  double cut[Nh] = { 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5 };
  ...
  c2->cd(1)->SetGrid();
  TH1F* Hc1=c2->cd(1)->DrawFrame( 1,  0.0,10.0, 200.0 );
  ...
  c3->cd(1)->SetGrid();
  TH1F* Hc2=c3->cd(1)->DrawFrame( 5,  0.0, 12.5, 200.0 );
