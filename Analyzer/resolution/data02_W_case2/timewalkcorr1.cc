...
void timewalkcorr1()
{
  ...
  TH2F *hist[2];
  hist[0] = new TH2F("h1", "TOF1vsWIDTH1", 1000, 0, 5, 50, -5, 5);
  hist[1] = new TH2F("h2", "TOF1vsWIDTH2", 1000, 0, 5, 50, -5, 5);
  ...
  for(int i = 0; i<n; ++i){
    ...
    if(180.0<ltdc1[0]&&ltdc1[0]<190.0&&180.0<ltdc2[0]&&ltdc2[0]<190.0&&
      ...
      hist[0]->Fill(w1,(ltdc1[0]-ltdc2[0])+0.58);
      hist[0]->GetXaxis()->SetTitle("WIDTH1");
      hist[0]->GetYaxis()->SetTitle("TOF");
      
      hist[1]->Fill(w2,(ltdc1[0]-ltdc2[0])+0.58);
