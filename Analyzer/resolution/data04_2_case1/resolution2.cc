...
void resolution2()
{
  ...
  for(int i = 0; i<n; ++i){
    ...
    if( ltdc1[0]>0&&ltdc2[0]>0&&amp1[0]>0&&amp2[0]>0){
      ...
      double TOFa = ((ltdc1[0]-ltdc2[0])+0.20)-T1;
      double TOF1 = TOFa-T2;
	...
	hist22[3]->Fill(rA2);
      ...
      if( rA1>12.0 && rA2>12.0){
	hist[4]->Fill(TOF+0.01);
	hist21[4]->Fill(rA1);
	hist22[4]->Fill(rA2);
      }
      if( rA1>14.0 && rA2>14.0){
	hist[5]->Fill(TOF-0.0);
	hist21[5]->Fill(rA1);
	hist22[5]->Fill(rA2);
      }
      if( rA1>16.0 && rA2>16.0){
	hist[6]->Fill(TOF-0.0);
	hist21[6]->Fill(rA1);
	hist22[6]->Fill(rA2);
      }
      if( rA1>18.0 && rA2>18.0){
	hist[7]->Fill(TOF-0.0);
	hist21[7]->Fill(rA1);
	hist22[7]->Fill(rA2);
      }
  ...
  c2->cd(1)->SetGrid();
  TH1F* Hc1=c2->cd(1)->DrawFrame( 5.0,  0.0, 23.0, 170.0 );
