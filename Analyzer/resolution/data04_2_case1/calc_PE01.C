void calc_PE01()
{
  ...
  double ph1[N]  =  {29.17, 37.97, 48.39, 58.09, 67.87, 77.92};  
  double ph1E[N] =  { 0.02,  0.03,  0.10,  0.09,  0.13,  0.14};  

  double ph2[N]  =  {26.93, 36.52, 47.37, 55.92, 65.73, 75.26};  
  double ph2E[N] =  { 0.06,  0.06,  0.03,  0.08,  0.11,  0.15};  
