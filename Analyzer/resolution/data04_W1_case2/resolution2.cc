...
void resolution2()
{
 ...
 for(int i = 0; i<n; ++i){
	...
	hist22[5]->Fill(rw2);
      ...
      if( rw1>10.0 && rw2>10.0 ){
	hist[6]->Fill(TOF+0.03);
	hist21[6]->Fill(rw1);
	hist22[6]->Fill(rw2);
      }
      if( rw1>10.5 && rw2>10.5 ){
  ...
  double cut[Nh] = { 2.0, 7.0, 8.0, 8.5, 9.0, 9.5, 10.0, 10.5 };
  ...
  c3->cd(1)->SetGrid();
  TH1F* Hc2=c3->cd(1)->DrawFrame( 5,  0.0, 11.5, 170.0 );
