...
void resolution2()
{
  ...
  hist[6] = new TH1F("h7", "TOF7",  80, -1, 1);
  hist[7] = new TH1F("h8", "TOF8",  70, -1, 1);
 ...
 for(int i = 0; i<n; ++i){
    ...
    if(172.0<ltdc1[0]&&ltdc1[0]<182.0&&172.0<ltdc2[0]&&ltdc2[0]<182.0&& 
      ...
      double w1 = ltdc3[0]-ttdc3[0]-1.6;
      double w2 = ltdc4[0]-ttdc4[0]-0.9;
      ...
      double TOFa = ((ltdc1[0]-ltdc2[0])+0.22)-T1;
      double TOF1 = TOFa-T2;
	...
	hist22[2]->Fill(rw2);
      ...
      if( rw1>7.0 && rw2>7.0 ){
	hist[3]->Fill(TOF+0.03);
	hist21[3]->Fill(rw1);
	hist22[3]->Fill(rw2);
      }
      if( rw1>7.5 && rw2>7.5 ){
	hist[4]->Fill(TOF+0.04);
	hist21[4]->Fill(rw1);
	hist22[4]->Fill(rw2);
      }
      if( rw1>8.0 && rw2>8.0 ){
	hist[5]->Fill(TOF+0.04);
	hist21[5]->Fill(rw1);
	hist22[5]->Fill(rw2);
	}
      if( rw1>8.5 && rw2>8.5 ){
	hist[6]->Fill(TOF+0.06);
	hist21[6]->Fill(rw1);
	hist22[6]->Fill(rw2);
      }
      if( rw1>9.0 && rw2>9.0 ){
	hist[7]->Fill(TOF+0.04);
	hist21[7]->Fill(rw1);
	hist22[7]->Fill(rw2);
      }
    }
  ...
  double cut[Nh] = { 2.0, 4.0, 6.0, 7.0, 7.5, 8.0, 8.5, 9.0 };
  ...
  c2->cd(1)->SetGrid();
  TH1F* Hc1=c2->cd(1)->DrawFrame( 1,  0.0, 10.0, 170.0 );
  ...
  c3->cd(1)->SetGrid();
  TH1F* Hc2=c3->cd(1)->DrawFrame( 5,  0.0, 10.0, 170.0 );
