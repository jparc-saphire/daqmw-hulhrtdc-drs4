void calc_PE01()
{
  ...
  double ph1[N]  =  {113.3, 132.8, 152.0, 172.4, 191.1};  
  double ph1E[N] =  { 0.08,  0.13,  0.15,  0.15,  0.18};  

  double ph2[N]  =  {93.30, 112.7, 132.1, 151.3, 171.0};  
  double ph2E[N] =  { 0.08,  0.08,  0.10,  0.12,  0.15};  
