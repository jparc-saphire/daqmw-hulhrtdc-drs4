...
void plot_tic_qdc1()
{
  ...
  tree->Add("rootfile/run801.root");
  tree->Add("rootfile/run802.root");
  tree->Add("rootfile/run803.root");
...
#if FILEOUT
  new TFile("analysis.root", "recreate");
#endif

  TH2F *tmp = HB2(0, "nanika", 130100,0,130100, 500,0,500);
  SetTitle(tmp, "Time interval [10 us]", "ADC count");
