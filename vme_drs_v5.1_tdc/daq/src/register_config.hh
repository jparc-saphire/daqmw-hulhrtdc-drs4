...
namespace register_config {
  ...
  //    static const unsigned int kReadCount = 512;
  // default up to 2024/6/1
  static const unsigned int kReadCount = 1022;//def
  //static const unsigned int kReadCount = 1024;
  //  static const unsigned int kReadCount = 2048;//does not work
  ...
  //sako 2023/3/8
  //    static const unsigned int kMTMDelay = 20;
  //sako 2024/4/26 for E16
  //  static const unsigned int kMTMDelay = 150;//1.5us (signal at 2us)
  //  2024/4/27
  //  static const unsigned int kMTMDelay = 200;//1.5us (signal at 2us)
  //4/28 00:05
  //    static const unsigned int kMTMDelay = 150;//1.5us (signal at 2us)
  //  static const unsigned int kMTMDelay = 235;//diference of E16 and local trigger=1850ns 50+185=235
  //  static const unsigned int kMTMDelay = 234;//diference of E16 and local trigger=1850ns 50+185=235
  //wrong  static const unsigned int kMTMDelay = 1890;//diference of E16 and local trigger=1850ns 50+185=235
  //2024/5/2 21:26
  static const unsigned int kMTMDelay = 0;//diference of E16 and local trigger=1850ns 50+185=235
  ...
  //______________________________________________________________________________
  //up to 5/2 22:35 default static const unsigned short kEVBControl  = EVB::c_reverse_window;
  static const unsigned short kEVBControl  = EVB::c_reverse_window;
  //test sako 5/2 22:36
  //  static const unsigned short kEVBControl  = 0;
  ...
  static const unsigned short kOMNNimOut2 = 0;
