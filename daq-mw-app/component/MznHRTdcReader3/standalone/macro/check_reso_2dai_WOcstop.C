...
void check_reso_2dai_WOcstop()
{
  gROOT->SetStyle("MyStyle");

  TFile *f1 = new TFile("./rootfile/run998.root");
  ...
  TFile *f2 = new TFile("../HRTDCv6/rootfile/run998.root");
  ...
  TH2F *hist2d = new TH2F("hist2d", "hist2d", 10000, 0, 10000, 8000, 0, 8000);
  ...
  for(int i = 0; i<n_event; ++i){
    ...
    t0= (s_tdc1[0]-((i-6500)*2.17718)+5000)*time_semi + count1/NofEntry*time_semi;
    t1= s_tdc2[0]*time_semi + count2/NofEntry*time_semi;
    double time = t0 > t1 ? t0-t1 : (8191.-t1)+t0;
    std::cout << time << std::endl;

    if(i>6500) htof[0]->Fill(time);
    hist2d->Fill(i, time);
  }// for(i)
