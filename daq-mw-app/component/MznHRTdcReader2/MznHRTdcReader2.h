...
#ifndef MZNHRTDCREADER2_H
#define MZNHRTDCREADER2_H
...
public:
  MznHRTdcReader2(RTC::Manager* manager);
  MznHRTdcReader2(const MznHRTdcReader2&)             = delete;
  MznHRTdcReader2& operator=(const MznHRTdcReader2&)  = delete;
  MznHRTdcReader2(MznHRTdcReader2&&)                  = delete;
  MznHRTdcReader2& operator=(MznHRTdcReader2&&)       = delete;
  virtual ~MznHRTdcReader2()                           = default;
