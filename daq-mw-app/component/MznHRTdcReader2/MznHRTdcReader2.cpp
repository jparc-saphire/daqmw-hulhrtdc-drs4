...
static const char* mzn_hrtdc_reader_spec[] =
  {
    "implementation_id", "MznHRTdcReader2",
    "type_name",         "MznHRTdcReader2",
    "description",       "MznHRTdcReader2 component",
    "version",           "1.0",
...
//______________________________________________________________________________
MznHRTdcReader2::MznHRTdcReader2(RTC::Manager* manager)
...
//______________________________________________________________________________
RTC::ReturnCode_t MznHRTdcReader2::onInitialize()
{
  if (m_debug) {
    std::cerr << "MznHRTdcReader2::onInitialize()" << std::endl;
  }
...
//______________________________________________________________________________
RTC::ReturnCode_t MznHRTdcReader2::onExecute(RTC::UniqueId ec_id)
{
  daq_do();
...
//______________________________________________________________________________
int MznHRTdcReader2::daq_dummy()
{
  return 0;
}

//______________________________________________________________________________
int MznHRTdcReader2::daq_configure()
{
  std::cerr << "*** MznHRTdcReader2::configure" << std::endl;
...
//E16 trig
  ...
  std::cout << "***************************" << std::endl;
  std::cout << "MznHRTdcReader2 Initialized" << std::endl;
  std::cout << "***************************" << std::endl;
...
//______________________________________________________________________________
int MznHRTdcReader2::parse_params(::NVList* list)
{
...
//______________________________________________________________________________
int MznHRTdcReader2::daq_unconfigure()
{
  std::cerr << "*** MznHRTdcReader2::unconfigure" << std::endl;

  return 0;
}

//______________________________________________________________________________
int MznHRTdcReader2::daq_start()
{
  std::cerr << "*** MznHRTdcReader2::start" << std::endl;
  reset_sequence_num();
...
//______________________________________________________________________________
int MznHRTdcReader2::daq_stop()
{
  std::cerr << "*** MznHRTdcReader2::stop" << std::endl;
...
//______________________________________________________________________________
int MznHRTdcReader2::daq_pause()
{
  std::cerr << "*** MznHRTdcReader2::pause" << std::endl;

  return 0;
}

//______________________________________________________________________________
int MznHRTdcReader2::daq_resume()
{
  std::cerr << "*** MznHRTdcReader2::resume" << std::endl;

  return 0;
}

//______________________________________________________________________________
int MznHRTdcReader2::read_data_from_detectors()
{
  if (m_debug) {
...
int MznHRTdcReader2::set_data(unsigned int data_byte_size)
{
...
//______________________________________________________________________________
int MznHRTdcReader2::write_OutPort()
{
...
//______________________________________________________________________________
int MznHRTdcReader2::daq_run()
{
  if (m_debug) {
    std::cerr << "*** MznHRTdcReader2::run" << std::endl;
  }
...
extern "C"
{
  void MznHRTdcReader2Init(RTC::Manager* manager)
  {
    RTC::Properties profile(mzn_hrtdc_reader_spec);
    manager->registerFactory(profile,
                             RTC::Create<MznHRTdcReader2>,
                             RTC::Delete<MznHRTdcReader2>);
  }
};
