...
xterm -T MznHRTdcReader2 -bg lightblue -geom 100x10+640+400 -e tail -F  /tmp/daqmw/log.MznHRTdcReader2Comp &
xterm -T MznHRTdcReader3 -bg lightblue -geom 100x10+640+600 -e tail -F  /tmp/daqmw/log.MznHRTdcReader3Comp &
